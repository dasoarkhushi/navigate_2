...
export default function Home() {
  ...
  const paperBackground =
    theme.palette.mode === "light" ? colors.grey[100] : colors.primary[600];
  const paperText =
    theme.palette.mode === "light" ? colors.grey[900] : colors.grey[100];
  ...
  return (
    ...
    >
      ...
      <Box sx={{ py: 12, background: colors.primary[800] }}>
        <Container maxWidth="lg">
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              <Typography variant="h2" fontWeight="bold" gutterBottom>
                Your Mutual Fund Portfolio, One Dashboard
              </Typography>
              <Typography variant="h6" sx={{ mb: 4 }}>
                Track, analyze, and optimize your mutual fund investments with
                live NAV insights, SIP tracking, and AI-powered analytics.
              </Typography>
              <Button
                variant="contained"
                size="large"
            ...
            <Grid item xs={12} md={6}>
              <Box
                component="img"
                src="trade analytics.jpeg"
                alt="Mutual Fund Dashboard Overview"
                sx={{
                  width: "100%",
                  height: "80%",
                  borderRadius: 4,
      ...
      <Container maxWidth="lg" sx={{ py: 10 }}>
        ...
        <Typography
          align="center"
          sx={{ mb: 6, fontSize: "1.1rem", color: colors.grey[300] }}
        >
          Explore NAVigate&apos;s smart tools to manage your mutual fund
          investments.
        </Typography>
        <Grid container spacing={4}>
          {[
            ...
            <Grid item xs={12} sm={6} md={4} key={index}>
              ...
              >
                ...
                <Typography variant="body2">
                  Discover how this feature helps enhance your mutual fund
                  strategy and grow your long-term wealth.
                </Typography>
              </Paper>
            </Grid>
          ))}
      ...
      <Container maxWidth="sm" sx={{ pb: 10 }}>
        ...
        >
          ...
          <Typography variant="body2" sx={{ mb: 3 }}>
            Get curated mutual fund insights, SIP and NAV updates, and weekly
            market recaps directly in your inbox.
          </Typography>
          <Box sx={{ display: "flex", gap: 2 }}>
            <TextField
              fullWidth
